...
const ColorBtn = (props) => {
    ...
    return (React.createElement("div", { className: `font-color-button ${color === activeColor ? 'active' : ''}`, onClick: onClickHandler, onTouchEnd: onTouchEndHandler },
        React.createElement("div", { className: "circle", style: { backgroundColor: hexToRgba(color, 1) } })));
};
...
export const FillColors = (props) => {
    ...
    const ColorBar = useMemo(() => {
        ...
        return (React.createElement("div", { className: "color-bar-fill" },
            React.createElement("div", { className: "circle", style: { backgroundColor } })));
    }, [activeColor, opacity]);
    return (React.createElement("div", { className: `button normal-button font-colors-icon ${showSubBtn && 'active'}`, onTouchEnd: (e) => {
            e.stopPropagation();
            e.nativeEvent.stopImmediatePropagation();
...
export const TextColors = (props) => {
    ...
    const ColorBar = useMemo(() => {
        ...
        return (React.createElement("div", { className: "color-bar" },
            React.createElement("div", { className: "color-bar-color", style: { backgroundColor } })));
    }, [activeColor, opacity]);
    return (React.createElement("div", { className: `button normal-button font-colors-icon ${showSubBtn && 'active'}`, onTouchEnd: (e) => {
            e.stopPropagation();
            e.nativeEvent.stopImmediatePropagation();
...
export const TextBgColors = (props) => {
    ...
    const SubOpacityBtn = useMemo(() => {
        if (activeColor && activeColor !== 'transparent') {
            return React.createElement(OpacityBtn, { key: 'fontColors', opacity: opacity, activeColor: activeColor, setCurOpacity: (curOpacity, curColor, workState) => {
                    ...
                    setOpacity(curOpacity);
                    MethodBuilderMain.emitMethod(InternalMsgEmitterType.MainEngine, EmitEventType.SetColorNode, { workIds: [Storage_Selector_key], fontBgColor: activeColor && hexToRgba(curColor, curOpacity), workState, viewId: maranger?.viewId });
                } });
        }
        return null;
        ...
        if (showSubBtn) {
            return (React.createElement("div", { className: "font-colors-menu", style: subBtnStyle, onTouchEnd: (e) => {
                ...
                React.createElement(NoneColorBtn, { activeColor: activeColor, onTouchEndHandler: (e) => {
                        e.stopPropagation();
                        setColor('transparent');
                        MethodBuilderMain.emitMethod(InternalMsgEmitterType.MainEngine, EmitEventType.SetColorNode, { workIds: [Storage_Selector_key], fontBgColor: 'transparent', viewId: maranger?.viewId });
                    }, onClickHandler: (e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        setColor('transparent');
                ...
                floatBarColors.map((c, index) => {
                    ...
                    return (React.createElement(ColorBtn, { key: index, color: curColor, activeColor: activeColor, onTouchEndHandler: (e) => {
                            e.stopPropagation();
                            setColor(curColor);
                            MethodBuilderMain.emitMethod(InternalMsgEmitterType.MainEngine, EmitEventType.SetColorNode, { workIds: [Storage_Selector_key], fontBgColor: hexToRgba(curColor, opacity), viewId: maranger?.viewId });
                        }, onClickHandler: (e) => {
                            e.preventDefault();
                            e.stopPropagation();
                            setColor(curColor);
    ...
    return (React.createElement("div", { className: `button normal-button font-colors-icon ${showSubBtn && 'active'}`, onTouchEnd: (e) => {
        ...
        React.createElement(HighlightSvg, null),
        ColorBar,
        SubBtns));
};
