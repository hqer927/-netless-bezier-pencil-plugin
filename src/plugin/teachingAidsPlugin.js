...
// import type { Camera, Cursor, CursorAdapter, ImageInformation, RenderEngine, Room, RoomState} from "./types";
// import { InvisiblePlugin, isRoom, Displayer, isPlayer, ApplianceNames } from "./types";
// import { TeachingAidsPluginAttributes, TeachingAidsPluginOptions, DisplayerForPlugin, Logger, MemberState, TeachingAidsAdaptor, TeachingAidsManagerLike, canBindMethodType } from "./types";
...
//                 TeachingAidsPlugin.logger.info(`[TeachingAidsSinglePlugin plugin] bindMethodToObject ${methodName}`);
...
//                 return;
//             }
//             const _onAddedCursor = TeachingAidsPlugin.cursorAdapter.onAddedCursor as any;
//             (TeachingAidsPlugin.cursorAdapter as any).onAddedCursor = function (cursor: Cursor) {
