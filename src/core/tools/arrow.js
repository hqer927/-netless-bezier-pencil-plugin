...
export class ArrowShape extends BaseShapeTool {
    constructor(props) {
        ...
        Object.defineProperty(this, "arrowTipWidth", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    computFullArrowPoints(thickness) {
        ...
        const ps = [lineSegmentStartLeft, lineSegmentEndLeft, triangleSideLeft, this.tmpPoints[1],
    ...
    computTrianglePoints() {
        ...
        const ps = [triangleSideLeft, this.tmpPoints[1], triangleSideRight];
        return {
            points: ps.map(p => Point2d.Sub(p, this.tmpPoints[0]).XY).flat(1),
            rect: getRectFromPoints(ps),
            isTriangle: true,
