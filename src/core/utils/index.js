 ...
 * @public
 */
export function perimeterOfEllipse(rx, ry) {
 ...
 * @public
 */
export function canonicalizeRotation(a) {
    a = a % PI2;
    if (a < 0) {
        a = a + PI2;
    }
 ...
 * @public
 */
export function clockwiseAngleDist(a0, a1) {
 ...
 * @public
 */
export function counterClockwiseAngleDist(a0, a1) {
 ...
 * @public
 */
export function longAngleDist(a0, a1) {
 ...
 * @public
 */
export function lerpAngles(a0, a1, t) {
 ...
 * @public
 */
export function angleDelta(a0, a1) {
 ...
 * @public
 */
export function getSweep(C, A, B) {
 ...
 * @public
 */
export function snapAngle(r, segments) {
 ...
 * @public
 */
export function areAnglesCompatible(a, b) {
 ...
 * @public
 */
export function isAngleBetween(a, b, c) {
 ...
 * @public
 */
export function getArcLength(C, r, A, B) {
 ...
 * @public
 */
export function rangeIntersection(a0, a1, b0, b1) {
 ...
 * @public
 */
export const getStarBounds = (sides, w, h) => {
 ...
 * @public
 */
export function pointInCircle(A, C, r) {
 ...
 * @public
 */
export function pointInRect(A, point, size) {
 ...
 * @public
 */
export function pointInPolygon(A, points) {
    let windingNumber = 0;
    let a;
    let b;
 ...
 * @public
 */
export function pointInBounds(A, b) {
 ...
 * @public
 */
export function pointInPolyline(A, points, distance = 3) {
 ...
 * @public
 */
export function pointNearToPolyline(A, points, distance = 8) {
 ...
 * @public
 */
export function pointNearToLineSegment(A, p1, p2, distance = 8) {
    const d = Vec2d.DistanceToLineSegment(p1, p2, A);
    if (d < distance)
        return true;
    return false;
...
/** @public */
export function simplify2(points, tolerance = 1) {
    if (points.length <= 2)
        return points;
...
/** @public */
export function getMidX(pts) {
    const a = getMinX(pts);
    const b = getMaxX(pts);
    return a + (b - a) / 2;
}
/** @public */
export function getMidY(pts) {
    const a = getMinY(pts);
    const b = getMaxY(pts);
    return a + (b - a) / 2;
}
/** @public */
export function getWidth(pts) {
    const a = getMinX(pts);
    const b = getMaxX(pts);
    return b - a;
}
/** @public */
export function getHeight(pts) {
    const a = getMinY(pts);
    const b = getMaxY(pts);
    return b - a;
}
